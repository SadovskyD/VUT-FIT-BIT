...
VALUES ('Dmytro', 'xsadov06@gmail.com', 'attist');

INSERT INTO "Agency/Artist" ("name", "email", "client_t")
VALUES ('Eduard', 'xgalli01@gmail.com', 'agency');

INSERT INTO "Employee" ("name", "position", "email")
VALUES ('Alexander Serov', 'cleaner', 'rando_mail@mail.com');

INSERT INTO "Employee" ("name", "position", "email")
VALUES ('Jeff Bezos', 'guide', 'rando_mail2@amazon.com');

INSERT INTO "Exposition" ("name", "begining_time", "end_time", "pay_stat", "client_id")
VALUES ('The African Origin of Civilization', '14-12-2021', '14-06-2022', '0', '1');

INSERT INTO "Exposition" ("name", "begining_time", "end_time", "pay_stat", "client_id", "employee_id")
VALUES ('A New Look at Old Masters', '12-12-2020', '12-12-2021', '1', '1','2');

INSERT INTO "Work" ("name", "creation date", "autor", "style", "exp_id")
VALUES ('Seated Male Nude in Three-Quarter View, with Right Arm Extended to the Left', '1774�75', 'Jacques Louis David', 'Radical Draftsman', '2');

INSERT INTO "Work" ("name", "creation date", "autor", "style", "exp_id")
VALUES ('The Combat of Diomedes', '1776', 'Jacques Louis David', 'Radical Draftsman','2');

INSERT INTO "Work" ("name", "creation date", "autor", "exp_id")
VALUES ('Plank piece I and II', '1973', 'Charles Ray ', '1');

INSERT INTO "Work" ("name", "creation date", "autor", "exp_id")
VALUES ('Tractor', '2005', 'Charles Ray', '2');
