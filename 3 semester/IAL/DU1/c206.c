...
void DLL_Init( DLList *list ) {
	//nastavte všechny ukazatele na NULL
...
void DLL_InsertFirst( DLList *list, int data ) {
	...
	DLLElementPtr newElemPtr = (DLLElementPtr) malloc(sizeof(DLList));
	if(newElemPtr==NULL){
		DLL_Error();
	}
	else{
		//nastavime data a ukazatele pro novy prvek
		newElemPtr->previousElement=NULL;
		newElemPtr->nextElement=list->firstElement;
		newElemPtr->data=data;
		//pokud seznam prazdny tak vlozeny element bude posledni
...
void DLL_DeleteFirst( DLList *list ) {
	...
	if (list->firstElement != NULL){
		...
		free(list->firstElement);
		list->firstElement=Next;
		//pokud prvek byl posledni, tak nastavime ukazatel na aktivni a posledni element na NULL
		if (Next == NULL){
			list->activeElement=NULL;
			list->lastElement=NULL;
		}
...
void DLL_DeleteAfter( DLList *list ) {
	...
	if (list->activeElement != NULL &&  list->activeElement != list->lastElement){
		//ulozime ukazatel na nasledujici element
